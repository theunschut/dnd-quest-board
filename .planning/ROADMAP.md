...
| 34. Codebase Cleanup & Security Hardening | v5.0 | 1/5 | In Progress|  |
...
- [ ] 34.2-01-PLAN.md — follow-up quest two-phase consolidation into `QuestService.CreateFollowUpQuestWithDetailsAsync` (D-01/D-04) + `DateTime.Now`→`UtcNow` in ShopSeedService
- [ ] 34.2-02-PLAN.md — net-new `ControllerExtensions` MVC-boilerplate helpers (D-02) applied to AdminController user/quest-admin actions (Resend/EmailStats excluded per D-03)
