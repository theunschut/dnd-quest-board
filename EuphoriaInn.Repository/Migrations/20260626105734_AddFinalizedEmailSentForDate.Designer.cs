...
namespace EuphoriaInn.Repository.Migrations
{
    ...
    [Migration("20260626105734_AddFinalizedEmailSentForDate")]
    partial class AddFinalizedEmailSentForDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EuphoriaInn.Repository.Entities.CharacterImageEntity", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuphoriaInn.Repository.Entities.DungeonMasterProfileEntity", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuphoriaInn.Repository.Entities.DungeonMasterProfileImageEntity", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuphoriaInn.Repository.Entities.TradeItemEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuphoriaInn.Repository.Entities.UserEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuphoriaInn.Repository.Entities.CharacterImageEntity", b =>
                {
                    b.HasOne("EuphoriaInn.Repository.Entities.CharacterEntity", "Character")
                        ...
                        .HasForeignKey("EuphoriaInn.Repository.Entities.CharacterImageEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EuphoriaInn.Repository.Entities.DungeonMasterProfileEntity", b =>
                {
                    b.HasOne("EuphoriaInn.Repository.Entities.UserEntity", null)
                        .WithOne()
                        .HasForeignKey("EuphoriaInn.Repository.Entities.DungeonMasterProfileEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("EuphoriaInn.Repository.Entities.DungeonMasterProfileImageEntity", b =>
                {
                    b.HasOne("EuphoriaInn.Repository.Entities.DungeonMasterProfileEntity", "DungeonMasterProfile")
                        .WithOne("ProfileImage")
                        .HasForeignKey("EuphoriaInn.Repository.Entities.DungeonMasterProfileImageEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EuphoriaInn.Repository.Entities.PlayerDateVoteEntity", b =>
                {
                    ...
                    b.HasOne("EuphoriaInn.Repository.Entities.ProposedDateEntity", "ProposedDate")
            ...
            modelBuilder.Entity("EuphoriaInn.Repository.Entities.QuestEntity", b =>
                {
                    b.HasOne("EuphoriaInn.Repository.Entities.UserEntity", "DungeonMaster")
                        .WithMany("Quests")
            ...
            modelBuilder.Entity("EuphoriaInn.Repository.Entities.ShopItemEntity", b =>
                {
                    b.HasOne("EuphoriaInn.Repository.Entities.UserEntity", "CreatedByDm")
                        .WithMany()
            ...
            modelBuilder.Entity("EuphoriaInn.Repository.Entities.TradeItemEntity", b =>
                {
                    b.HasOne("EuphoriaInn.Repository.Entities.UserEntity", "OfferedByPlayer")
                        .WithMany()
            ...
            modelBuilder.Entity("EuphoriaInn.Repository.Entities.UserTransactionEntity", b =>
                {
                    b.HasOne("EuphoriaInn.Repository.Entities.UserTransactionEntity", "OriginalTransaction")
                        .WithMany()
